  ...
  useEffect(() => {
    async function fetchUserDetails() {
      ...
      if (storedUserDetails != null) {
        ...
        if (parsedDetails.token && parsedDetails.userName && parsedDetails.userRole && parsedDetails.userId) {
  ...
  return (
    <AuthContextProvider>
      <PaperProvider theme={customTheme} >
        <StatusBar barStyle="dark-content" backgroundColor={COLORS.ACCENT_ORANGE} />
        <Root />
